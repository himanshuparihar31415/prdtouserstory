...
export default function Step5Page() {
  ...
  return (
    <WizardShell step={5} title="Story Editing" description="Review and fine-tune each story — modify the user role, action, benefit, and acceptance criteria.">
      ...
      <StepFooter step={5} canProceed={stories.length > 0} nextLabel="Finalize & Export" />
    </WizardShell>
  );
}
