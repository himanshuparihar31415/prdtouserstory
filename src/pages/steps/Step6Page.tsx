...
export default function Step6Page() {
  ...
  return (
    <WizardShell step={6} title="Finalize & Export" description="Approve stories one-by-one or in bulk, then export your complete structured output.">
      {/* Mode toggle */}
      ...
      <StepFooter step={6} hideNext canProceed={false} />
    </WizardShell>
  );
}
